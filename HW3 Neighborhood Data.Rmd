---
#title: "HW3 Neighborhood Data"
#author: "Adelia Fida"
#group: "Mahrukh Jaura,Thakur Chimire"
#date: "09/30/2021"


load("acs2017_ny_data.RData")
PUMA_lev <-read.csv("PUMA_levels.csv")
dat_NYC <- subset(acs2017_ny, (acs2017_ny$in_NYC == 1) & (acs2017_ny$AGE > 30) & (acs2017_ny$AGE < 60))
...
add_test <- COSTGAS + COSTWATR + COSTELEC + COSTFUEL + FUELHEAT + FAMSIZE + married
# Combined common household utilities with size of family and marriage status. We had the idea that family size is relevant to what neighborhoods you live in based on you income. We also estimated that the more children you have the higher chance of the person being married.
...
[1] 2.0000000 0.5933619
[1] 4.0000000 0.3007985
[1] 6.0000000 0.2217852
# We can predict with approximately 59% accuracy what neighborhood a person lives in based on the variables used in our code as well as thier closest neighbor.
